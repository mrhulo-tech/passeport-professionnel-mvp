# Passeport Professionnel MVP

MVP de formation professionnelle centré sur :
- le profil d’apprentissage ;
- les compétences transversales ;
- les indicateurs interprétables ;
- les recommandations personnalisées ;
- la requalification, l’employabilité et la littératie IA.
